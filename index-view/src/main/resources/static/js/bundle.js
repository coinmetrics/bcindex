...
var GraphService = function () {
    ...
    _createClass(GraphService, [{
        ...
        value: function init() {
            ...
            fetch(_config2.default.mult).then(function (r) {
                return r.text();
            }).then(function (d) {
                return JSON.parse(d);
                ...
                var graph = _this.transformDataToChartJsDataSet(result);
                _this.renderLineChart(graph.labels, graph.dataset);
        ...
        value: function update(payload) {
            ...
            fetch(_config2.default.data, {
                ...
                var graph = _this2.transformDataToChartJsDataSet(result.data);
                _this2.renderLineChart(graph.labels, graph.dataset);
                _this2.stockInfoService.draw(result);
            });
        }
    }, {
        key: 'transformDataToChartJsDataSet',
        value: function transformDataToChartJsDataSet(model) {
            var result = new Array();
            var lineColor = (0, _color2.default)('rgb(104, 140, 33)');
            var object = function object(data, lineColor) {
                return {
                    label: 'Price',
                    data: data,
            ...
            try {
                for (var _iterator = model.prices[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
},{"./StockInfoService.js":2,"./config.js":4,"color":10}],2:[function(require,module,exports){
'use strict';
...
},{"color-name":8,"simple-swizzle":12}],10:[function(require,module,exports){
'use strict';
